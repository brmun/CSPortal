...
//	$.ajax({
//		type:"POST",
//		url:  "/admin/ajax/ES_CustomerInfo.jsp?type=getLisenceList1&t="+encodeURI(A)+"",
...
//					t= hits[0]._source.company_id;
						...
						$.ajax({
							type:"POST",
							url:  "/admin/ajax/ES_CustomerInfo.jsp?type=getLisenceList2&t="+encodeURI(A)+"",
							contentType: "application/json; charset=UTF-8",
							dataType:"text",
							timeout: 30000,
							success : function(data) {
...
function getsupportList(A)
{
	...
	$.ajax({
		type:"POST",
		url:  "/admin/ajax/ES_CustomerInfo.jsp?type=getsupportList&t="+encodeURI(A)+"",
		contentType: "application/json; charset=UTF-8",
		dataType:"text",
		timeout: 30000,
		success : function(data) {
...
function getCustomerInfo(A)
{
	...
	$.ajax({
		type:"POST",
		url:  "/admin/ajax/ES_CustomerInfo.jsp?type=getCustomerInfo&t="+encodeURI(A)+"",
		contentType: "application/json; charset=UTF-8",
		dataType:"text",
		timeout: 30000,
		success : function(data) {
