...
//	console.log(crmdomain)
	...
	if (statFilter == "null" && categoryFilter == "null" )
	{
		...
		ES_URL = "/admin/ajax/ES_MaList.jsp?type=MaList&title="+title+"&status=none&t=\"all\"&offset="+offset+"&size="+size+"&array="+encodeURI(jsonString)+"&timeFrom=\""+timeFrom+"\"&timeTo=\""+timeTo+"\"";
	}
