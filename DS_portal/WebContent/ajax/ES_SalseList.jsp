	...
	if ( "\"all\"".equals(t))
	{
		...
		if ( type.equals("MaList") )
		{
			...
			else if ( status.equals("p") )
			{
				...
				}else if(title.equals("기술지원")||title.equals("기술지원요청")){
					category ="\"기술지원요청\"";
					if(state.equals("1")){
						stat ="\"담당할당\",\"진행중\",\"개발\",\"개발완료\",\"오픈\"";
						timeFrom = "\"now-999d/d\"";
				...
				}else if(title.equals("추가개발")||title.equals("추가개발요청")){
					category ="\"추가개발요청\"";
					if(state.equals("1")){
						stat ="\"담당할당\",\"진행중\",\"개발\",\"개발완료\",\"오픈\"";
						timeFrom = "\"now-999d/d\"";
				...
				}else if(title.equals("기타요청")){
					category ="\"영업문의\",\"영업제안서지원\",\"사내보안지원\",\"사내전산지원\",\"디자인 요청\",\"디자인 요청(사업)\",\"유지보수해외지원\",\"보안취약점\",\"내부업무/기타\"";
					if(state.equals("1")){
						stat ="\"담당할당\",\"진행중\",\"개발\",\"개발완료\",\"오픈\"";
						timeFrom = "\"now-999d/d\"";
						timeTo = "\"now\"";
				...
				}else if(title.equals("POC/데모")){
					category ="\"POC/데모\"";
					System.out.println("222222222" +category);
					if(state.equals("1")){
						stat ="\"담당할당\",\"진행중\",\"개발\",\"개발완료\",\"오픈\"";
						timeFrom = "\"now-999d/d\"";
						timeTo = "\"now\"";
		...
		if ( type.equals("MaList") )
		{
			...
			else if ( status.equals("p") )
			{
				...
				if(title.equals("1주내")){
					...
					category ="\"POC/데모\"";
					System.out.println("111111111111111111111" +category);
					if(state.equals("1")){
						stat ="\"담당할당\",\"진행중\",\"개발\",\"개발완료\",\"오픈\"";
						timeFrom = "\"now-999d/d\"";
						timeTo = "\"now\"";
