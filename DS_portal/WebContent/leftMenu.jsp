	    ...
	    <section class="sidebar">
	      ...
	      <ul class="sidebar-menu" data-widget="tree">
	        ...
	        <li class="treeview" id="softcampMenu">
	          <a href="#" onclick="all_Dashboard(); return false; this.onclick=null;"><i class="fa fa-database"></i> <span class="">고객사 전체 현황</span>
<!-- 	          <a href="#" onclick="certification(); return false; this.onclick=null;"><i class="fa fa-cog"></i> <span class="i18n-leftmenu-preferences"></span> -->
	        ...
	        <li class="treeview" id="softcampsales">
	          <a href="#" onclick="salse_Dashboard(); return false; this.onclick=null;"><i class="fa fa-database"></i> <span class="">영업대표 티켓 현황</span>
<!-- 	          <a href="#" onclick="certification(); return false; this.onclick=null;"><i class="fa fa-cog"></i> <span class="i18n-leftmenu-preferences"></span> -->
	            <span class="pull-right-container">
	                <i class="fa fa-angle-left pull-right"></i>
	              </span>
	          ...
	          <ul class="treeview-menu">
	            <li><a href="#" onclick="salse_Dashboard(); return false; this.onclick=null;"><i class="fa fa-dashboard"></i> <span class="i18n-leftmenu-dashboard"></span></a></li>
	            <li><a href="#" onclick="salse_MaList(); return false; this.onclick=null;"><i class="fa fa-gears"></i> <span class="">지원 요청 현황</span></a></li>
