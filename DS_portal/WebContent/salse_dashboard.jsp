	          		...
	          		<tr>
	          			<td>
		          			<div class="info-box text-center">
								<span class="" style="font-size: 20px;">분류별 현황</span>
							    <div class="line">
...
<!-- 				          	<div class="system_cpu_graph"></div> -->
	          			...
	          			<td>
	          				<div class="info-box text-center">
								<span class="" style="font-size: 20px;">처리 현황(최근 3개월)</span>
							    <div class="line">
...
<!-- 	          				<div class="system_disk_graph"></div> -->
	          		...
	          		<tr>
	          			<td>
		          			<div class="info-box text-center">
								<span class="" style="font-size: 20px;">접수 Top10 고객사</span>
							    <div class="line">
...
<!-- 				          	<div class="system_cpu_graph"></div> -->
	          			...
	          			<td>
		          			<div class="info-box text-center">
								<span class="" style="font-size: 20px;">접수 Top10 영업대표</span>
							    <div class="line">
...
<!-- 				          	<div class="system_cpu_graph"></div> -->
	        ...
	        <!-- /.box-body -->
<!-- 	          	<table id="systemDashboard2" class="table" style="cursor: pointer" > -->
<!-- 	          		<tr> -->
<!-- 	          			<td> -->
<!-- 		          			<div class="info-box text-center"> -->
<!-- 								<span class="" style="font-size: 20px;">리소스 현황</span> -->
<!-- 							    <div class="line"> -->
<!-- 									<canvas id="abatement-SERes-chart" style="height:300px"> -->
<!-- 									</canvas> -->
<!-- 								</div> -->
<!-- 					            /.info-box-content -->
<!-- 					          </div> -->
...
<!-- 	          			<td> -->
<!-- 	          				<div class="info-box text-center"> -->
<!-- 								<span class="" style="font-size: 20px;">진행중 티켓 현황</span> -->
<!-- 							    <div class="line"> -->
<!-- 									<canvas id="abatement-SETicket-chart" style="height:300px"> -->
<!-- 									</canvas> -->
<!-- 								</div> -->
<!-- 					            /.info-box-content -->
<!-- 					          </div> -->
