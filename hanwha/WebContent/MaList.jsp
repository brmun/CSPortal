	...
	<div class="box">
		...
		<!--        	 			</select> -->
					 ...
					 <span style="border: 0; background-color: unset; font-size: 15px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;상태 :</span>
					  <select id="stat_filter" class="stat_filter" style="border: 10; background-color: unset; font-size: 15px; text-align-last: center;" onchange="getMaList();">
					 ...
					 <span style="border: 0; background-color: unset; font-size: 15px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;지원유형 :</span>
					  <select id="category_filter" class="category_filter" style="border: 10; background-color: unset; font-size: 15px; text-align-last: center;" onchange="getMaList();">
								<option value="null">전체</option>
								...
								<option value='기술자료요청","패키징요청","영업문의","영업지원'>기타</option>
							</select>
<!-- 							<select id="PRIORITY_filter" class="PRIORITY_filter" style="border: 10; background-color: unset; font-size: 15px; text-align-last: center;" onchange="getMaList();"> -->
<!-- 								<option value="null">전체</option> -->
...
<!-- 							</select>		 -->
		 ...
		 <a id="btnExport" href="#" download="">
						            ...
						            <label class="label-stat-term" style="margin-top: 4px;">
					           		...
					           		<label class="label-stat-term" style="margin-top: 4px; margin-right: -1px;">
						           		<input type="radio" class="flat" name="RadioPeriodType" id="status_period" value="select"><span class="span-margin-right2 i18n-statistics-tab-all-period-custom"></span>
												...
												<input type="text" class="form-control mail-daterange" id="reservation" style="display: none; width: 43%" onchange="getMaList();">	              
					            </div>
										</div>
		        			</div>
			          </div>
            ...
            <div class="box-body" id="wrap">
              <table class="table table-bordered table-hover" id="tblExport">
              	<colgroup>
					<col style="width: 10%"/>
              		<col style="width: 10%"/>
              		<col style="width: 5%"/>
