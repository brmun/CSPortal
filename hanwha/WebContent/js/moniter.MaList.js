...
//		console.log(A);
		...
		ES_URL = "/hanwha/ajax/ES_MaList.jsp?type=MaList&title="+title+"&status=none&t="+encodeURI(A)+"&offset="+offset+"&size="+size+"&array="+encodeURI(jsonString)+"&timeFrom=\""+timeFrom+"\"&timeTo=\""+timeTo+"\"";
	}
	else if ( statFilter == "null" )
	{
		var jsonString = "{\"type\":"+JSON.stringify(array)+"}";
		ES_URL = "/hanwha/ajax/ES_MaList.jsp?type=MaList&status=category&t="+encodeURI(A)+"&offset="+offset+"&size="+size+"&array="+encodeURI(jsonString)+"&categoryFilter="+categoryFilter+"&timeFrom=\""+timeFrom+"\"&timeTo=\""+timeTo+"\"";
	}
	else if ( categoryFilter == "null" )
	{
		var jsonString = "{\"type\":"+JSON.stringify(array)+"}";
		ES_URL = "/hanwha/ajax/ES_MaList.jsp?type=MaList&status=stat&t="+encodeURI(A)+"&offset="+offset+"&size="+size+"&array="+encodeURI(jsonString)+"&statFilter="+statFilter+"&timeFrom=\""+timeFrom+"\"&timeTo=\""+timeTo+"\"";
	}
	
	else
	{
		var jsonString = "{\"type\":"+JSON.stringify(array)+"}";
		ES_URL = "/hanwha/ajax/ES_MaList.jsp?type=MaList&status=all&t="+encodeURI(A)+"&offset="+offset+"&size="+size+"&array="+encodeURI(jsonString)+"&categoryFilter="+categoryFilter+"&statFilter="+statFilter+"&timeFrom=\""+timeFrom+"\"&timeTo=\""+timeTo+"\"";
	}
...
//		isOriginal = isOrigin;
	...
	$.ajax({
		type: "POST",
		url: "/hanwha/ajax/ES_MaList.jsp?type=MaContent&ticket_no="+Ticket_No+"",
		contentType: "application/json; charset=UTF-8",
		dataType: "text",
		timeout: 30000,
		async: false,
...
//					$.ajax({
//						type: "POST",
//						url: "/hanwha/ajax/ES_MaList.jsp?type=MaComment&Ticket_id="+hits[0]._source.TICKET_ID+"",
//						contentType: "application/json; charset=UTF-8",
//						dataType: "text",
//						async: false,
//						timeout: 30000,
...
//									    	$.ajax({
//											type: "POST",
//											url: "/hanwha/ajax/ES_MaList.jsp?type=Macomment2&Ticket_id="+hits1[i]._source.COMMENTS_ID+"",
//											contentType: "application/json; charset=UTF-8",
//											dataType: "text",
//											async: false,
//											timeout: 30000,
...
//														    	$.ajax({
//																type: "POST",
//																url: "/hanwha/ajax/ES_MaList.jsp?type=Macomment2&Ticket_id="+hits2[j]._source.COMMENTS_ID+"",
//																contentType: "application/json; charset=UTF-8",
//																dataType: "text",
//																async: false,
//																timeout: 30000,
...
function getMaListSearch(item) {
	...
	$.ajax({
		type:"POST",
		url: "/hanwha/ajax/ES_MaList.jsp?type=MaListSearch&t="+encodeURI(A)+"&offset="+offset+"&size="+size+"&searchKeyword=\"*"+searchKeyword+"*\"",
		contentType: "application/json; charset=UTF-8",
		dataType:"JSON",
		timeout: 30000,
		success : function(data) {
...
function getMaListDetailSearch(item) {
	...
	$.ajax({
		type:"POST",
		url: "/hanwha/ajax/ES_MaList.jsp?type=MaListDetailSearch&t="+encodeURI(A)+"&offset="+offset+"&size="+size+"&filters=\""+filters+"\"&searchKeyword=\"*"+searchKeyword+"*\"&timeFrom=\""+timeFrom+"\"&timeTo=\""+timeTo+"\"",
		contentType: "application/json; charset=UTF-8",
		dataType:"JSON",
		timeout: 30000,
		success : function(data) {
...
function getMainMaStatTotal()
{
	...
	$.ajax({
		type:"POST",
		url: "/hanwha/ajax/ES_MaList.jsp?type=MainMaStatTotal",
		contentType: "application/json; charset=UTF-8",
		dataType:"text",
		timeout: 30000,
		success : function(data) {
...
function test()
{
	...
	$.ajax({
		type:"POST",
		url: "/hanwha/ajax/ES_MaList.jsp?type=MaListDetailSearch&offset=1&size=10&filters=\"장애\"&searchKeyword=\"**\"&timeFrom=\""+timeFrom+"\"&timeTo=\""+timeTo+"\"",
		contentType: "application/json; charset=UTF-8",
		dataType:"text",
		timeout: 30000,
		success : function(data) {
