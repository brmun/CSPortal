...
function modifyUser(idx, userdocid){
	...
	if( password != confirmPassword ){
		...
		$.ajax({
			type:"POST",
			url: "http://10.10.10.229:9200/hanwha_usergroup_info/hanwha_usergroup/"+userdocid+"/_update",
			contentType: "application/json; charset=UTF-8",
			data: jsonData,
			dataType:"JSON",
			timeout: 30000,
...
function delOrg(idx) {
	...
	$.ajax({
		type: "DELETE",
		url: "http://10.10.10.229:9200/hanwha_usergroup_info/hanwha_usergroup/"+idx,
		contentType: "application/json; charset=UTF-8",
		dataType: "JSON",
		timeout: 30000,
		success: function(data){
