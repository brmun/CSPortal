...
<body>
  ...
  <input type="hidden" name="myurl" id="myurl" value="all_ProjectList.jsp">
            ...
            <div class="box-header">
              ...
              <h3 class="box-title"><span class="">진행 프로젝트 현황</span><span>( </span><span id="recCount"></span><span> 건)</span></h3>
               ...
               <span style="border: 0; background-color: unset; font-size: 15px; color: black;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;사업유형 :</span>
					  <select id="stat_filter" class="stat_filter" style="border: 10; background-color: unset; font-size: 15px; color: black; text-align-last: center;" onchange="all_getProjectList();">
