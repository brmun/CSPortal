...
//		isOriginal = isOrigin;
	...
	$.ajax({
		type: "POST",
		url: "/hkmc/ajax/ES_MaList.jsp?type=MaContent&ticket_no="+Ticket_No+"",
		contentType: "application/json; charset=UTF-8",
		dataType: "text",
		timeout: 30000,
		async: false,
...
//					$.ajax({
//						type: "POST",
//						url: "/hkmc/ajax/ES_MaList.jsp?type=MaComment&Ticket_id="+hits[0]._source.TICKET_ID+"",
//						contentType: "application/json; charset=UTF-8",
//						dataType: "text",
//						async: false,
//						timeout: 30000,
...
//									    	$.ajax({
//											type: "POST",
//											url: "/hkmc/ajax/ES_MaList.jsp?type=Macomment2&Ticket_id="+hits1[i]._source.COMMENTS_ID+"",
//											contentType: "application/json; charset=UTF-8",
//											dataType: "text",
//											async: false,
//											timeout: 30000,
...
//														    	$.ajax({
//																type: "POST",
//																url: "/hkmc/ajax/ES_MaList.jsp?type=Macomment2&Ticket_id="+hits2[j]._source.COMMENTS_ID+"",
//																contentType: "application/json; charset=UTF-8",
//																dataType: "text",
//																async: false,
//																timeout: 30000,
