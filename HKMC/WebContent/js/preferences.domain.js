...
function getDomainList(item) {
	...
	if(searchKeyword == "")
	{
		ES_URL = "/hkmc/ajax/ES_Domain.jsp?type=getDomainList&offset="+offset+"&size="+size+"&searchKeyword=none";
	}else{
		ES_URL = "/hkmc/ajax/ES_Domain.jsp?type=getDomainList&offset="+offset+"&size="+size+"&searchKeyword="+searchKeyword+"";
	}
...
//	$.ajax({
//		type:"POST",
//		url: "http://10.10.10.229:9200/hkmc_usergroup_info/_search",
//		contentType: "application/json; charset=UTF-8",
//		data: getPortal,
//		dataType:"JSON",
//		timeout: 30000,
...
function update_domain(domainid){
	...
	$.ajax({
		type: "POST",
		url: "http://10.10.10.229:9200/hkmc_usergroup_info/hkmc_usergroup/"+domainid+"/_update",
		contentType: "application/json; charset=UTF-8",
		data: jsonData,
		dataType: "JSON",
		timeout: 30000,
...
function delete_domain(domainid){
	...
	$.ajax({
		type: "DELETE",
		url: "http://10.10.10.229:9200/hkmc_usergroup_info/hkmc_usergroup/"+domainid,
		contentType: "application/json; charset=UTF-8",
		dataType: "JSON",
		timeout: 30000,
		success: function(data){
