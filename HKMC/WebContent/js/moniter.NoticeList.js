...
{
	ES_URL = "/hkmc/ajax/ES_DashBoard.jsp?type=getNoticeList";
...
function getNoticeContent(Notice_No,isOrigin) {
	...
	ES_URL = "/hkmc/ajax/ES_DashBoard.jsp?type=getNoticeContent&Notice_No="+encodeURI(Notice_No)+"";
...
//				html += "        <div id=\"divContent\" style=\"min-width: 900px; max-width: 1000px; height: 50%;\">";
				...
				$.ajax({
					url: "http://hkmc.softcamp.co.kr/notice/"+hits[0]._source.timeCreated+".htm",
